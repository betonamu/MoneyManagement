package com.example.doanjava.helpers;
...
public class CurrencyEditText extends AppCompatEditText {
    ...
    private CurrencyTextWatcher currencyTextWatcher = new CurrencyTextWatcher(this, GlobalConst.prefix);
    ...
    public CurrencyEditText(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.setHint(GlobalConst.prefix);
    ...
    private void handleCaseCurrencyEmpty(boolean focused) {
        if (focused) {
            if (getText().toString().isEmpty()) {
                setText(GlobalConst.prefix);
            }
        } else {
            if (getText().toString().equals(GlobalConst.prefix)) {
                setText("");
            }
        }
    }
